...
import { CreditCard, Coffee, Globe, Heart } from 'lucide-react'
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-300 text-center leading-relaxed">
            Love this app? Your support keeps it growing! Pick a way to contribute and help me build more features. Every little bit counts—thank you!
          </p>
          ...
          <div className="space-y-3">
            <Button
              ...
              onClick={() => handleDonate('https://paypal.me/YOURPAYPALID')}
            >
            ...
            <Button
              ...
              onClick={() => handleDonate('https://www.buymeacoffee.com/YOURUSERNAME')}
            >
              <div className="flex items-center gap-3">
            ...
            <Button
              variant="secondary"
              size="lg"
              className="w-full h-16 rounded-2xl hover:bg-green-50 dark:hover:bg-green-950/20 hover:border-green-200 dark:hover:border-green-800 transition-all duration-200"
              onClick={() => handleDonate('https://wise.com/YOURWISELINK')}
            >
              <div className="flex items-center gap-3">
                <Globe className="w-6 h-6 text-green-600" />
                <span className="text-lg font-medium">Send via Wise</span>
              </div>
            </Button>
          </div>
